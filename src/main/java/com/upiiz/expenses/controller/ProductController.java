...
@RestController
@CrossOrigin(origins = {"http://localhost:4200", "https://proyecto-final-web-omega.vercel.app"}, methods = {RequestMethod.GET, RequestMethod.POST, RequestMethod.PUT, RequestMethod.DELETE})
